...
return [
    ...
    */
    ...
    'The given data was invalid.' => 'Неверные учетные данные.',
    ...
    */
    'custom' => [
        'inn' => [
            'unique' => 'Пользователь с таким ИНН уже зарегистрирован, обратитесь к администратору сайта чтобы решить разногласия.',
        ],
        'email' => [
